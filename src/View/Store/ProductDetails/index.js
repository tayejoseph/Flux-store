...
const ProductDetails = () => {
  ...
  return (
    <Container>
      ...
      <Modal showModal={true} className="modal-size_md modal-close_relative">
        <div className="productDetails-container">
          <main className="flux-row">
            ...
            <div className="flux-col">
              <h2 className="u-typo_title productDetails-title">
                Product Details
              </h2>

              <h3 className="u-typo_title">{name}</h3>
              <p className="product-details">{description}</p>
              <div className="action-row">
                <div className="action-label_row">
                  <h2 className="u-typo_title product-price">
                    ₦{toMoney(amount)}
                  </h2>
                  <span className="dot">&#8226;</span>
                  <p className="product-status">Published</p>
                </div>
                <Button className="btn-delete btn-unpublish">Unpublish</Button>
              </div>
              <hr />
              ...
              <div className="product-summary">
                <div className="flux-row">
                  <p>Items remaining</p>
                  <p className="u-color_dark">{quantity}</p>
                </div>
                <div className="flux-row">
                  <p>Delivery</p>
          ...
          <footer className="flux-row">
            <div className="img-container_row">
